    ...
    <div class="container"  >
        <div class="row justify-content-center ">
            <div class="col-md-8" style="margin-top: 4%;">
                <div class="card">
                    <div class="card-header text-center " style="font-size: x-large"><strong>{{ __('Update Details') }}</strong></div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row ">
                                <div class="col-md-6 offset-md-4">
                                    <a class="nav-link text-center" href="{{ route('home') }}">{{ __('Go back') }}</a>
                                </div>
                            </div>
                        </form>
