    ...
    <div class="container py-5">
        <div class="p-5 bg-white rounded shadow mb-5">
            ...
            <ul id="myTab1" role="tablist" class="nav nav-tabs nav-pills with-arrow flex-column flex-sm-row text-center">
                ...
                <li class="nav-item flex-sm-fill">
                    <a id="profile1-tab" data-toggle="tab" href="#profile1" role="tab" aria-controls="profile1" aria-selected="false" class="nav-link text-uppercase font-weight-bold mr-sm-3 rounded-0 border">Analyze</a>
                </li>
                <li class="nav-item flex-sm-fill">
                ...
                <li class="nav-item flex-sm-fill">
                    <a id="chat-tab" data-toggle="tab" href="#chat1" role="tab" aria-controls="chat1" aria-selected="false" class="nav-link text-uppercase font-weight-bold rounded-0 border">Conversations</a>
                </li>
            ...
            <div id="myTab1Content" class="tab-content">
                ...
                <div id="chat1" role="tabpanel" aria-labelledby="chat-tab" class="tab-pane fade px-4 py-5">
